package dev.qubik.coreui;

import dev.qubik.CoreConfiguration;
...
@PropertySource(name = "dev.qubik.coreui", value = "classpath:/dev/qubik/coreui/module.properties")
public class CoreuiConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("dev.qubik.coreui"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("dev.qubik.coreui"));
        return actions;
    }
}
